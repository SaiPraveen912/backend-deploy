...
resource "null_resource" "backend" {
    ...
    provisioner "remote-exec" {    
        inline = [      
              ...
              "sudo sh /tmp/${var.common_tags.Component}.sh ${var.common_tags.Component} ${var.environment} ${var.app_version}" # the version from terraform goes to backend.sh in this way
        ]  
    }
